        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-grid gap-2 mt-3">
                    <a href="/ruta/al/carrito-completo" class="btn btn-primary">Ver carrito completo</a>
                </div>
            </div>
        </div>
    </div>
...
<!-- Botón de WhatsApp que abre el modal del carrito -->
<a href="#cartModal" class="carrito-btn bg-accent" data-bs-toggle="modal" rel="noopener noreferrer" 
    data-bs-placement="left" title="Carrito">
