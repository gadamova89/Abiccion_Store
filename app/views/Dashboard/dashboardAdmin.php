                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        ...
                        <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                            ...
                            <li class="w-100">
                                <a href="#" class="nav-link px-0 btn-ajax" data-url="<?= APP_URL ?>Usuarios/administrarClientes"> <span class="d-none d-sm-inline">Clientes</span>
                    ...
                    <li>
                        <a href="#" class="nav-link px-0 align-middle btn-ajax" data-url="<?= APP_URL ?>Productos/administrarProductos">
                    ...
                    <li>
                        <a href="#" class="nav-link px-0 align-middle btn-ajax" data-url="<?= APP_URL ?>Categorias/administrarCategorias">
                    ...
                    <li>
                        <a href="" class="nav-link px-0 align-middle btn-ajax" data-url="<?= APP_URL ?>Usuarios/administrarPersonal">
                            <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline">Personal</span>
